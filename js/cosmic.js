document.addEventListener('DOMContentLoaded', function() {
    ...
    async function sendMessage() {
        ...
        if (message.toLowerCase().startsWith('контент')) {
            ...
            systemPrompt = `Ты — генератор реального контента. Для запроса "${topic}" выбери одну случайную тему (формулы, книги, наука, история) и сгенерируй 3 абзаца с реальными фактами по этой теме. Формат: "[Тема в кавычках или формула].\nОбъяснение: [Краткое, понятное объяснение].\nP.S.: [Факт]."
Примеры:
